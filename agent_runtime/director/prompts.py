...
def director_system_prompt() -> str:
    return (
        ...
        "- When one object should sit on, against, beside, above, below, or align to another object, use object.place_on_surface, object.place_against, object.place_relative, or object.align_to instead of guessing raw coordinates.\n"
        "Reference policy:\n"
        ...
        "- Raw coordinates are mainly for empty-scene bootstrap and camera or light placement; prefer geometric relations for mesh placement.\n"
